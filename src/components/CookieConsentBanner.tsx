                ...
                >
                  <div className="space-y-3 py-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Immer aktiv – für den Betrieb der Website erforderlich
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-xl bg-secondary/30">
                      ...
                      <button
                        type="button"
                        onClick={() => setLocalPrefs((current) => ({ ...current, analytics: !current.analytics }))}
                      ...
                      >
                        <div
                          className={`w-5 h-5 rounded-full transition-all ${
                            localPrefs.analytics ? "bg-primary-foreground ml-auto" : "bg-muted-foreground/50"
                          }`}
                        />
                      </button>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-xl bg-secondary/30">
                      ...
                      <button
                        type="button"
                        onClick={() => setLocalPrefs((current) => ({ ...current, marketing: !current.marketing }))}
                        className={`w-11 h-6 rounded-full flex items-center px-0.5 transition-colors ${
                      ...
                      >
                        <div
                          className={`w-5 h-5 rounded-full transition-all ${
                            localPrefs.marketing ? "bg-primary-foreground ml-auto" : "bg-muted-foreground/50"
                          }`}
                        />
                      </button>
                    </div>
