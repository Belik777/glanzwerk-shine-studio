...
export default function Kontakt() {
  ...
  return (
    <>
      <SEOHead
        title="Kontakt – MS Glanzwerk | Termin vereinbaren in Merzig"
        description="Kontaktieren Sie MS Glanzwerk in Merzig für einen Termin zur professionellen Autopflege. Telefon: 0177 2725455."
        canonical="/kontakt"
      />
