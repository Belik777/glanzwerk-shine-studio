...
export default function Kontakt() {
  ...
  return (
    <>
      <SEOHead title="Kontakt – MS Glanzwerk Merzig" description="Kontaktieren Sie MS Glanzwerk in Merzig für professionelle Autopflege. Termin vereinbaren unter 0177 2725455." />
